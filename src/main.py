...
#estes criado pelo próprio professor.

arq = open('texto')
arq2 = open("texto2")
arq3 = open("texto3")
strings = arq.readlines()
strings2 = arq2.readlines()
strings3 = arq3.readlines()
    ...
    if i[0] != "a" and i[0] != "b" and i[0] != "c":
        ...
        if x is True:
            if i == strings[len(strings)-1]:
                ...
                print(i[0:len(i) - 1], ": pertence!")
        else:
            if i == strings[len(strings)-1]:
                print(i, ": não pertence!")
            else:
                print(i[0:len(i) - 1], ": não pertence!")
